...
namespace Shapes
{
    public static class FontHelper
    {
        ...
        {
            SetFont("Consolas", FONT_SIZE, FONT_SIZE * FONT_DIFFERENCE);
            Console.WindowHeight = originalWindowHeight;
        }

        public static void SetSmallFont()
        {
            SetFont("Terminal", FONT_SIZE, FONT_SIZE);
            Console.WindowHeight = originalWindowHeight * FONT_DIFFERENCE;
        }

        private static unsafe void SetFont(string fontName, short x, short y)
        {
